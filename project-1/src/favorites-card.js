...
<div class = "has-background-danger-dark has-text-black">
    ...
    <button class = "button is-primary column is-full">Delete Favorite?</button>
</div>
`;
...
class Favoritecard extends HTMLElement
{
    ...
    connectedCallback()
    {
        ...
        { 
            ...
            deleteFavorite(favorites["favorites"].name.indexOf(this.h1.innerHTML), favorites["favorites"].primary_attr.indexOf(this.p1.innerHTML), favorites["favorites"].attack_type.indexOf(this.p2.innerHTML), favorites["favorites"].image.indexOf(this.img.src), favorites["favorites"].attack_rate.indexOf(this.p3.innerHTML), favorites["favorites"].attack_range.indexOf(this.p4.innerHTML), favorites["favorites"].base_health.indexOf(this.p5.innerHTML));
...
customElements.define("favorites-card", Favoritecard);