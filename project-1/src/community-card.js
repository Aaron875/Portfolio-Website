...
<div class = "has-background-danger-dark has-text-black">
    ...
    <h1 class = "has-text-centered column is-full is-size-5"></h1>
    <h2 class = "has-text-centered column is-full is-size-4 box has-background-danger-dark has-text-black"></h2>
...
class Communitycard extends HTMLElement
{
    ...
    {
        return ["data-name", "data-numfavorites", "data-attacktype", "data-attribute", "data-attackrate", "data-image", "data-attackrange", "data-hp"];
    }

    render()
    {
       const name = this.getAttribute("data-name") ? this.getAttribute("data-name") : "<i>...hero name...</i>";
       const numFavorites = this.getAttribute("data-numfavorites") ? this.getAttribute("data-numfavorites") : "0";
       ...
       this.h2.innerHTML = `Favorited by ${numFavorites} users`;
